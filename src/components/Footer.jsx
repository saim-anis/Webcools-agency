...
const Footer = () => {
  return (
    <div className="w-full min-h-[50vh] bg-[#0a012d]">
    <footer className="m-4 bg-neutral-primary-soft">
  <div className="w-full max-w-7xl p-4 py-6 lg:py-8">
    <div className="md:flex md:justify-between">
      <div className="mb-6 md:mb-0">
        ...
        <p className='max-w-75 sm:m-1.5'>We are a Creative agency Dedicated to delivering exceptional digital solutions. </p>
      </div>
